...
export const ALL_PRODUCTS_NOFILTER_REQUEST = 'ALL_PRODUCTS_NOFILTER_REQUEST'
export const ALL_PRODUCTS_NOFILTER_SUCCESS = 'ALL_PRODUCTS_NOFILTER_SUCCESS'
export const ALL_PRODUCTS_NOFILTER_FAIL = 'ALL_PRODUCTS_NOFILTER_FAIL'
...
export const GET_REVIEWS_REQUEST = 'PRODUCT_DETAILS_REQUEST'
export const GET_REVIEWS_SUCCESS = 'PRODUCT_DETAILS_SUCCESS'
export const GET_REVIEWS_FAIL = 'PRODUCT_DETAILS_FAIL'
